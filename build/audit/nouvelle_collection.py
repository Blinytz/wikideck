...
PLANS = {
    ...
    'cepages': dict(
        nom='Cépages célèbres',
        # Beaucoup de pages de cepage portent le nom du VIN, ou d'une commune :
        # « Chardonnay » est un village de Saone-et-Loire, « Marsanne » une
        # commune de la Drome, « Pinot noir » et « Riesling » parlent du vin.
        # D'ou les titres entre parentheses, verifies un par un : chaque
        # resume retenu parle bien du raisin. Le nom de carte, lui, garde la
        # graphie usuelle : « Albarino » plutot que « Alvarinho », « Ugni
        # blanc » plutot que « Trebbiano », « Chenin blanc » plutot que
        # « Chenin ». Ecarte : le xinomavro, sans page sur fr.wikipedia.
        transferts=[],
        ajouts=[
            # Rouges
            ('Cabernet sauvignon', 'Cabernet sauvignon'),
            ('Merlot', 'Merlot'),
            ('Pinot noir', 'Pinot noir (cépage)'),
            ('Syrah', 'Syrah'),
            ('Grenache', 'Grenache'),
            ...
            ('Montepulciano', 'Montepulciano (cépage)'),
            ...
            ('Trousseau', 'Trousseau'),
            ('Négrette', 'Négrette'),
            ('Pinot meunier', 'Meunier (cépage)'),
            ('Mondeuse noire', 'Mondeuse noire'),
            ('Saperavi', 'Saperavi'),
            # Blancs
            ('Chardonnay', 'Chardonnay (cépage)'),
            ('Sauvignon blanc', 'Sauvignon'),
            ('Riesling', 'Riesling (cépage)'),
            ('Chenin blanc', 'Chenin'),
            ('Viognier', 'Viognier'),
            ('Sémillon', 'Sémillon'),
            ('Gewurztraminer', 'Gewurztraminer (cépage)'),
            ('Muscat à petits grains', 'Muscat blanc à petits grains'),
            ('Pinot gris', 'Pinot gris (cépage)'),
            ('Grüner Veltliner', 'Grüner Veltliner'),
            ('Albariño', 'Alvarinho'),
            ('Marsanne', 'Marsanne (cépage)'),
            ('Roussanne', 'Roussanne'),
            ('Melon de Bourgogne', 'Melon (cépage)'),
            ('Aligoté', 'Aligoté'),
            ('Savagnin', 'Savagnin'),
            ('Vermentino', 'Vermentino'),
            ('Ugni blanc', 'Trebbiano'),
            ('Palomino', 'Palomino (cépage)'),
            ('Furmint', 'Furmint'),
            ('Pedro Ximénez', 'Pedro ximénez'),
            ('Picpoul', 'Picpoul'),
            ('Mauzac', 'Mauzac (cépage)'),
            ('Colombard', 'Colombar (cépage)'),
            ('Petit manseng', 'Petit manseng'),
            ('Gros manseng', 'Gros manseng'),
            ('Clairette', 'Clairette (cépage)'),
            ('Sylvaner', 'Sylvaner (cépage)'),
            ('Chasselas', 'Chasselas (cépage)'),
            ('Jacquère', 'Jacquère'),
    ...
    'monnaies-du-monde': dict(
        nom='Monnaies du monde',
        # Les monnaies EN CIRCULATION. Beaucoup de pages portent un titre plus
        # long que le nom courant : « Sol (monnaie du Perou) », « Tenge
        # kazakh », « Won sud-coreen (depuis 1962) ». Le nom de carte garde la
        # forme usuelle. Le guarani porte « (monnaie) » : sans cela il serait
        # l'homonyme de la langue, deja carte.
        transferts=[],
        ajouts=[
            # Les grandes monnaies de reserve
            ('Euro', 'Euro'),
            ...
            ('Peso argentin', 'Peso argentin'),
            ('Peso chilien', 'Peso chilien'),
            ('Peso colombien', 'Peso colombien'),
            ('Sol péruvien', 'Sol (monnaie du Pérou)'),
            ('Boliviano', 'Boliviano'),
            ('Guarani (monnaie)', 'Guarani (monnaie)'),
            ('Quetzal', 'Quetzal (monnaie)'),
            ('Balboa', 'Balboa (monnaie)'),
            # Europe hors zone euro
            ('Couronne suédoise', 'Couronne suédoise'),
            ('Couronne norvégienne', 'Couronne norvégienne'),
            ('Couronne danoise', 'Couronne danoise'),
            ('Złoty', 'Złoty'),
            ('Forint', 'Forint'),
            ('Couronne tchèque', 'Couronne tchèque'),
            ('Leu roumain', 'Leu roumain'),
            ('Hryvnia', 'Hryvnia'),
            ('Rouble russe', 'Rouble russe'),
            ('Livre turque', 'Livre turque'),
            # Afrique
            ('Rand', 'Rand (monnaie)'),
            ('Naira', 'Naira'),
            ('Cedi', 'Cedi'),
            ('Shilling kényan', 'Shilling kényan'),
            ('Birr', 'Birr'),
            ('Dirham marocain', 'Dirham marocain'),
            ('Dinar algérien', 'Dinar algérien'),
            ('Dinar tunisien', 'Dinar tunisien'),
            ('Livre égyptienne', 'Livre égyptienne'),
            ('Franc CFA', 'Franc CFA'),
            ('Kwacha zambien', 'Kwacha zambien'),
            ('Dollar namibien', 'Dollar namibien'),
            ('Ariary', 'Ariary'),
            # Proche et Moyen-Orient
            ('Riyal saoudien', 'Riyal saoudien'),
            ('Dirham des Émirats arabes unis', 'Dirham des Émirats arabes unis'),
            ('Riyal qatarien', 'Riyal qatarien'),
            ('Dinar koweïtien', 'Dinar koweïtien'),
            ('Dinar jordanien', 'Dinar jordanien'),
            ('Dinar irakien', 'Dinar irakien'),
            ('Rial iranien', 'Rial iranien'),
            ('Shekel', 'Shekel'),
            # Asie
            ('Roupie indienne', 'Roupie indienne'),
            ('Roupie pakistanaise', 'Roupie pakistanaise'),
            ('Taka', 'Taka'),
            ('Won sud-coréen', 'Won sud-coréen (depuis 1962)'),
            ('Nouveau dollar de Taïwan', 'Nouveau dollar de Taïwan'),
            ('Dollar de Hong Kong', 'Dollar de Hong Kong'),
            ('Dollar de Singapour', 'Dollar de Singapour'),
            ('Baht', 'Baht'),
            ('Dong', 'Dong (monnaie)'),
            ('Ringgit', 'Ringgit'),
            ('Roupie indonésienne', 'Roupie indonésienne'),
            ('Peso philippin', 'Peso philippin'),
            ('Kyat', 'Kyat'),
            ('Tugrik', 'Tugrik'),
            ('Tenge', 'Tenge kazakh'),
            # Oceanie
            ...
            ('Franc Pacifique', 'Franc Pacifique'),
        ],
    ),
    'monnaies-historiques': dict(
        nom='Monnaies historiques',
        # Les monnaies DISPARUES, de la drachme au Deutsche Mark. Le napoleon
        # n'y est pas : « Napoleon » est deja une carte de souverain. Le cauri
        # non plus : la seule page de fr.wikipedia est celle du mollusque,
        # « Monetaria moneta », et une carte de coquillage n'a rien a faire
        # dans une collection de monnaies.
        transferts=[],
        ajouts=[
            # Antiquite grecque et romaine
            ('Drachme', 'Drachme (Grèce antique)'),
            ('Statère', 'Statère'),
            ('Obole', 'Obole (monnaie)'),
            ('Talent', 'Talent (unité)'),
            ('Mine', 'Mine (unité)'),
            ('Sicle', 'Sicle'),
            ('Denier romain', 'Denier (monnaie)'),
            ('Sesterce', 'Sesterce'),
            ('As', 'As (monnaie)'),
            ('Aureus', 'Aureus'),
            ('Antoninien', 'Antoninien'),
            ('Follis', 'Follis'),
            # Byzance et le Moyen Age
            ('Solidus', 'Solidus (monnaie)'),
            ('Besant', 'Besant'),
            ('Hyperpère', 'Hyperpérion'),
            ('Denier franc', 'Denier franc'),
            ('Gros tournois', 'Gros tournois'),
            ('Livre tournois', 'Livre tournois'),
            ('Florin', 'Florin'),
            ('Ducat', 'Ducat'),
            ('Maravédis', 'Maravédis'),
            # L'age des grandes monnaies d'or et d'argent
            ('Écu', "Écu d'or"),
            ("Louis d'or", 'Louis (monnaie)'),
            ('Réal espagnol', 'Réal espagnol'),
            ('Doublon', 'Doublon (monnaie)'),
            ('Pistole', 'Pistole (monnaie)'),
            ('Piastre', 'Piastre'),
            ('Thaler', 'Thaler'),
            ('Souverain', 'Souverain (pièce en or)'),
            ('Guinée', 'Guinée (monnaie)'),
            ('Farthing', 'Farthing'),
            # Les monnaies nationales remplacees par l'euro
            ('Franc français', 'Franc germinal'),
            ('Franc belge', 'Franc belge'),
            ('Lire italienne', 'Lire italienne'),
            ('Peseta espagnole', 'Peseta espagnole'),
            ('Escudo portugais', 'Escudo portugais'),
            ('Florin néerlandais', 'Florin néerlandais'),
            ('Drachme grecque', 'Drachme (Grèce moderne)'),
            ('Schilling autrichien', 'Schilling autrichien'),
            ('Mark finlandais', 'Mark finlandais'),
            # Allemagne et bloc de l'Est
            ('Deutsche Mark', 'Deutsche Mark'),
            ('Reichsmark', 'Reichsmark'),
            ('Papiermark', 'Papiermark'),
            ('Rentenmark', 'Rentenmark'),
            ('Ostmark', 'Ostmark'),
            ('Rouble soviétique', 'Rouble soviétique'),
            # Ailleurs, et les monnaies qui n'etaient pas des pieces
            ('Sapèque', 'Sapèque'),
            ('Assignat', 'Assignat'),
            ('Wampum', 'Collier de wampum'),
        ],
    ),
    'noeuds': dict(
        nom='Nœuds',
        # Des noeuds qu'on fait avec une corde. Le noeud gordien n'y est donc
        # pas : c'est une legende, il releverait des objets mythiques. Le noeud
        # de trefle non plus, c'est un objet de topologie. Ni la surliure,
        # l'epissure et le matelotage, qui sont des techniques et non des
        # noeuds.
        transferts=[],
        ajouts=[
            # Les noeuds d'arret et de jonction
            ('Demi-nœud', 'Demi-nœud'),
            ('Nœud plat', 'Nœud plat'),
            ('Nœud en huit', 'Nœud en huit'),
            ('Nœud en huit en double', 'Nœud en huit en double'),
            ("Nœud d'écoute", "Nœud d'écoute"),
            ('Nœud de Carrick', 'Nœud de Carrick'),
            ('Nœud de Zeppelin', 'Nœud de Zeppelin'),
            ('Nœud de pêcheur', 'Nœud de pêcheur'),
            ('Nœud de pêcheur double', 'Nœud de pêcheur double'),
            ('Nœud double', 'Nœud double'),
            ('Nœud double gansé', 'Nœud double gansé'),
            ('Nœud en queue de cochon', 'Nœud en queue de cochon'),
            # Les boucles
            ('Nœud de chaise', 'Nœud de bouline'),
            ('Nœud de chaise double en huit', 'Nœud de chaise double en huit'),
            ('Nœud de chaise double sur son double', 'Nœud de chaise double sur son double'),
            ('Nœud de papillon alpin', 'Nœud de papillon alpin'),
            ('Nœud de plein poing', 'Nœud de plein poing'),
            ('Nœud coulant', 'Nœud coulant'),
            ('Nœud de pendu', 'Nœud de pendu'),
            # Les noeuds d'amarrage
            ('Demi-clef', 'Demi-clef'),
            ('Nœud de cabestan', 'Nœud de cabestan'),
            ('Nœud de demi-cabestan', 'Nœud de demi-cabestan'),
            ('Nœud de taquet', 'Nœud de taquet'),
            ('Nœud de grappin', 'Nœud de grappin'),
            ("Nœud en tête d'alouette", "Nœud en tête d'alouette"),
            ("Nœud d'élingue", "Nœud d'élingue"),
            ('Nœud de ride', 'Nœud de ride'),
            ('Nœud de laguis', 'Nœud de laguis'),
            ('Nœud de galère', 'Nœud de galère'),
            ('Nœud de jambe de chien', 'Nœud de jambe de chien'),
            ('Nœud de fouet', 'Nœud de fouet'),
            ('Nœud de bois', 'Nœud de bois'),
            # Escalade
            ('Nœud de Prusik', 'Nœud de Prusik'),
            ('Nœud de Machard', 'Nœud de Machard'),
            # Et ceux du quotidien
            ('Nœud de cravate', 'Nœud de cravate'),
            ('Nœud de cravate Windsor', 'Nœud de cravate Windsor'),
            ('Nœud de cravate demi-Windsor', 'Nœud de cravate demi-Windsor'),
            ('Petit nœud de cravate', 'Petit nœud de cravate'),
